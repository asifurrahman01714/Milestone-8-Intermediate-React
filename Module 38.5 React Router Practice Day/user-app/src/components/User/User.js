        ...
        <div className='col-md-4 '>
            <div className="card m-2" style={{width: '18rem'}}>
                ...
                <div className="card-body">
                    ...
                    <Link className="btn btn-primary d-flex justify-content-center mt-4"  to={`/https://omnigo.com.bd/AsifUrRahman/userdetails/userDetails/${id}`} onClick={()=>userDetails(user)}>See Details</Link>
                </div>
            </div>
        </div>
    );
